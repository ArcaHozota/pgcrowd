			...
			<div class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 main">
				...
				<div class="row">
					<div class="col" id="adminKanriMainmenu" role="button">
						<img nonce="Ytvk0lE3pg1BL713YR9i89Kn" src="/static/image/icons/castilia.svg" 
					...
					<div class="col" id="roleKanriMainmenu" role="button">
						<img nonce="Ytvk0lE3pg1BL713YR9i89Kn" src="/static/image/icons/burgundy.svg" 
					...
					<div class="col" id="categoryKanriMainmenu" role="button">
						<img nonce="Ytvk0lE3pg1BL713YR9i89Kn" src="/static/image/icons/bourbon.svg" 
